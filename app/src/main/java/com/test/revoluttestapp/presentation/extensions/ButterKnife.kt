...
package com.test.revoluttestapp.presentation.extensions
...
// <editor-fold desc="fun bindView(id: Int)">
...
// <editor-fold desc="fun bindOptionalView(id: Int)">
...
// <editor-fold desc="fun bindViews(vararg ids: Int)">
...
// <editor-fold desc="fun bindOptionalViews(vararg ids: Int)">
...
// <editor-fold desc="private val viewFinder: (Int) -> View?">
